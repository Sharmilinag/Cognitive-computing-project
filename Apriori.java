...
public class H_Apriori {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        transactionMap = getTransactions();
        trimData();
    ...
    private static void generateAssociations(Set<String> next) {
        ...
        while (elementsToEat <= totalIterations) {
            ...
            for (int i = 1;; i++) {
                ...
                } else if (i > (values.size() + 1 - (elementsToEat))) {
                    break;
                }
     ...
     */
    public static Map<Integer, String> getTransactions() throws FileNotFoundException {

        Map<Integer, String> transactionMap = new HashMap<Integer, String>();

        Scanner scan = new Scanner(new File("C:\\Users\\Kalyani Shirwalkar\\Documents\\NetBeansProjects\\CogComp\\src\\cogcomp\\data.txt"));
        int i = 1;
        String line, l[];
        while (scan.hasNextLine()) {
            line = scan.nextLine();
            //l = line.split("\\s+");
            transactionMap.put(i++, line);
        }
